...
How to Implement:
First, select a Linux VM to run worm.py on. Then open a terminal on the VM.
...
If the program executes correctly, the hosts of the other two VMs should recieve the infection.
Open the other VMs and open terminals in both of them.
